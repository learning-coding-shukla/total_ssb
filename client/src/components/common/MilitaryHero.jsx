    ...
    >
      ...
      >
        ...
        <div>
          ...
          <p className="mt-5 text-3xl font-semibold text-yellow-300 italic">
            "{motto}"
          </p>
          ...
          <div className="mt-10 flex flex-wrap gap-5">
            ...
            {primaryAction?.link ? (
              <Link to={primaryAction.link}>
                <MilitaryButton theme={theme} icon="🎯">
                  {primaryAction.label}
                </MilitaryButton>
              </Link>
            ) : (
            ...
            {secondaryAction?.link ? (
              <Link to={secondaryAction.link}>
                <MilitaryButton theme={theme} variant="secondary" icon="📚">
        ...
        <div className="grid grid-cols-2 gap-6">
          {stats.map((item, index) => (
            ...
            >
              ...
              <h2 className={`text-4xl font-black ${theme.stat}`}>
                {item.value}
              </h2>
