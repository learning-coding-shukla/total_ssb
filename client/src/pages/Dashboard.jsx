...
function Dashboard() {
  ...
  const bestSRT =
    Number(localStorage.getItem("srt_best")) || 0;

  const ppdtAttempts =
    Number(localStorage.getItem("ppdt_attempts")) || 0;
    ...
    <div className="min-h-screen bg-slate-100 p-8">
      ...
      <div className="max-w-5xl mx-auto mt-16 bg-white rounded-2xl shadow-xl p-8 text-center">
        ...
        <p className="text-slate-600 text-lg">
          Consistent practice in PPDT, WAT, SRT and TAT improves
          observation, imagination, decision making, communication
          skills and Officer Like Qualities (OLQs).
        </p>
