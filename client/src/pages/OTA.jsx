...
function OTA() {
  ...
  <div className="bg-yellow-50 p-6 rounded-xl shadow mt-8">
  ...
  <table className="w-full border">
    ...
    <tbody>
      ...
      <tr className="border">
        ...
        <td className="p-3">
          Limited service period, generally 10 years
          extendable up to 14 years.
        </td>
      </tr>
...
<div className="bg-green-50 p-6 rounded-xl shadow mt-8">
  <h2 className="text-3xl font-bold mb-4">
    Entries Through OTA
  </h2>
